...
import static com.xycm.cqxf.util.Util.pocUrl;
...
import com.xycm.cqxf.data.User;
import com.xycm.cqxf.dialog.CallReminderDialog;
import com.xycm.cqxf.dialog.LinkWayDialog;
import com.xycm.cqxf.dialog.MemberListDialog;
import com.xycm.cqxf.dialog.SelectPicDialog;
import com.xycm.cqxf.dialog.UnitListDialog;
import com.xycm.cqxf.event.CloseVideoActivityEvent;
import com.xycm.cqxf.event.OpenVideoActivityEvent;
import com.xycm.cqxf.event.QRScannerEvent;
import com.xycm.cqxf.event.ShowCallReminderDialogEvent;
import com.xycm.cqxf.service.KeepAliveService;
import com.xycm.cqxf.util.AndroidVersionUtils;
import com.xycm.cqxf.util.DatabaseManager;
import com.xycm.cqxf.util.FileUploader;
import com.xycm.cqxf.util.InvState;
import com.xycm.cqxf.util.Util;
...
public class MainActivity extends AppCompatActivity implements View.OnTouchListener, View.OnClickListener {
    ...
    private void startCamera() {
        try {
            ...
            // 通过FileProvider生成Uri
            photoUri = FileProvider.getUriForFile(MainActivity.this, "com.xycm.test31.fileprovider", photoFile);
