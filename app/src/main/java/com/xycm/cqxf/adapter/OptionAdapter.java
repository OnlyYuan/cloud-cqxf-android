...
public class OptionAdapter extends RecyclerView.Adapter<OptionAdapter.ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(TrunkingGroupContact item);
    }

    // 构造方法
    public OptionAdapter(List<TrunkingGroupContact> optionList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        // 绑定数据
        TrunkingGroupContact item = mOptionList.get(position);
